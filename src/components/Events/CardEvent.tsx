...
function CardEvent({
  ...
  return (
    <Link href={`/${id}`}>
      <div className='bg-white rounded-[20px] overflow-hidden drop-shadow-md hover:shadow-[0_0_15px_8px_rgba(0,0,0,0.1)] hover:cursor-pointer transition-all duration-300 w-[150px] sm:w-[240px]'>
        <div className='relative h-[120px] sm:h-[180px] w-full bg-MiExpo_purple/10'>
